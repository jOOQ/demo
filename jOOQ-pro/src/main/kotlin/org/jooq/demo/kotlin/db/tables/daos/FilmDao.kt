...
open class FilmDao(configuration: Configuration?) : DAOImpl<FilmRecord, org.jooq.demo.kotlin.db.tables.pojos.Film, Long>(Film.FILM, org.jooq.demo.kotlin.db.tables.pojos.Film::class.java, configuration) {
     ...
     * upperInclusive</code>
     */
    fun fetchRangeOfReleaseYear(lowerInclusive: Long?, upperInclusive: Long?): List<org.jooq.demo.kotlin.db.tables.pojos.Film> = fetchRange(Film.FILM.RELEASE_YEAR, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>release_year IN (values)</code>
     */
    fun fetchByReleaseYear(vararg values: Long): List<org.jooq.demo.kotlin.db.tables.pojos.Film> = fetch(Film.FILM.RELEASE_YEAR, *values.toTypedArray())
