...
import org.jooq.demo.kotlin.db.indexes.FILM_ACTOR_IDX_FK_FILM_ID
...
import org.jooq.demo.kotlin.db.keys.FILM_ACTOR__FILM_ACTOR_PKEY
...
open class FilmActor(
     ...
     */
    val LAST_UPDATE: TableField<FilmActorRecord, LocalDateTime?> = createField(DSL.name("last_update"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("now():::TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "")
    ...
    override fun getPrimaryKey(): UniqueKey<FilmActorRecord> = FILM_ACTOR__FILM_ACTOR_PKEY
