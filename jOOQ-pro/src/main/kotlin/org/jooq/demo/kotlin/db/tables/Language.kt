...
import org.jooq.demo.kotlin.db.keys.LANGUAGE__LANGUAGE_PKEY
...
open class Language(
     ...
     */
    val LAST_UPDATE: TableField<LanguageRecord, LocalDateTime?> = createField(DSL.name("last_update"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("now():::TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "")
    ...
    override fun getPrimaryKey(): UniqueKey<LanguageRecord> = LANGUAGE__LANGUAGE_PKEY
