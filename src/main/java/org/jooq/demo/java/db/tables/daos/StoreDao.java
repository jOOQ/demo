...
public class StoreDao extends DAOImpl<StoreRecord, org.jooq.demo.java.db.tables.pojos.Store, Long> {
     ...
     */
    public org.jooq.demo.java.db.tables.pojos.Store fetchOneByManagerStaffId(Long value) {
     ...
     * Fetch a unique record that has <code>manager_staff_id = value</code>
     */
    public Optional<org.jooq.demo.java.db.tables.pojos.Store> fetchOptionalByManagerStaffId(Long value) {
