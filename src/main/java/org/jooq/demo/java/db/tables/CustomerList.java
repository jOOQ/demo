...
import org.jooq.demo.java.db.tables.records.CustomerListRecord;
...
public class CustomerList extends TableImpl<CustomerListRecord> {
     ...
     */
    public final TableField<CustomerListRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR, this, "");
     ...
     */
    public final TableField<CustomerListRecord, String> NOTES = createField(DSL.name("notes"), SQLDataType.VARCHAR, this, "");
    ...
    private CustomerList(Name alias, Table<CustomerListRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view \"customer_list\" as SELECT cu.customer_id AS id, (((cu.first_name)::STRING || ' '::STRING) || (cu.last_name)::STRING) AS name, a.address, a.postal_code AS \"zip code\", a.phone, city.city, country.country, CASE WHEN cu.activebool THEN 'active'::STRING ELSE ''::STRING END AS notes, cu.store_id AS sid FROM (((sakila.public.customer AS cu JOIN sakila.public.address AS a ON ((cu.address_id = a.address_id))) JOIN sakila.public.city ON ((a.city_id = city.city_id))) JOIN sakila.public.country ON ((city.country_id = country.country_id)))"));
    }
