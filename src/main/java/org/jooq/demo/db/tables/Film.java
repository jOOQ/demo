...
public class Film extends TableImpl<FilmRecord> {
     ...
     */
    public final TableField<FilmRecord, MpaaRating> RATING = createField(DSL.name("rating"), SQLDataType.VARCHAR.defaultValue(DSL.field("'G':::public.mpaa_rating", SQLDataType.VARCHAR)).asEnumDataType(org.jooq.demo.db.enums.MpaaRating.class), this, "");
