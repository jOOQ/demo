...
public class CustomerRecord extends UpdatableRecordImpl<CustomerRecord> implements Record10<Long, Long, String, String, String, Long, Boolean, LocalDate, LocalDateTime, Long> {
    ...
    @Override
    public Row10<Long, Long, String, String, String, Long, Boolean, LocalDate, LocalDateTime, Long> valuesRow() {
    ...
    @Override
    public CustomerRecord value10(Long value) {
        setActive(value);
        return this;
    }

    @Override
    public CustomerRecord values(Long value1, Long value2, String value3, String value4, String value5, Long value6, Boolean value7, LocalDate value8, LocalDateTime value9, Long value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CustomerRecord(Long customerId, Long storeId, String firstName, String lastName, String email, Long addressId, Boolean activebool, LocalDate createDate, LocalDateTime lastUpdate, Long active) {
        super(Customer.CUSTOMER);
     ...
     * Create a detached, initialised CustomerRecord
     */
    public CustomerRecord(org.jooq.demo.db.tables.pojos.Customer value) {
        super(Customer.CUSTOMER);
