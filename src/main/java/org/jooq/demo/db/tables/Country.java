...
public class Country extends TableImpl<CountryRecord> {
     ...
     */
    public final TableField<CountryRecord, LocalDateTime> LAST_UPDATE = createField(DSL.name("last_update"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("now():::TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");
    ...
    public UniqueKey<CountryRecord> getPrimaryKey() {
        return Keys.COUNTRY__COUNTRY_PKEY;
    }
