...
public class Store extends TableImpl<StoreRecord> {
     ...
     */
    public final TableField<StoreRecord, LocalDateTime> LAST_UPDATE = createField(DSL.name("last_update"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("now():::TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");
    ...
    public UniqueKey<StoreRecord> getPrimaryKey() {
        return Keys.STORE__STORE_PKEY;
    }

    @Override
    public List<UniqueKey<StoreRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.STORE__IDX_UNQ_MANAGER_STAFF_ID);
    }
