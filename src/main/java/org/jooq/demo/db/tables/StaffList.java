...
import org.jooq.demo.db.tables.records.StaffListRecord;
...
public class StaffList extends TableImpl<StaffListRecord> {
     ...
     */
    public final TableField<StaffListRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR, this, "");
    ...
    private StaffList(Name alias, Table<StaffListRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view \"staff_list\" as SELECT s.staff_id AS id, (((s.first_name)::STRING || ' '::STRING) || (s.last_name)::STRING) AS name, a.address, a.postal_code AS \"zip code\", a.phone, city.city, country.country, s.store_id AS sid FROM (((sakila.public.staff AS s JOIN sakila.public.address AS a ON ((s.address_id = a.address_id))) JOIN sakila.public.city ON ((a.city_id = city.city_id))) JOIN sakila.public.country ON ((city.country_id = country.country_id)))"));
    }
