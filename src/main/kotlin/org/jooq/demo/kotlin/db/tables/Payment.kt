...
import org.jooq.demo.kotlin.db.indexes.PAYMENT_IDX_FK_CUSTOMER_ID
import org.jooq.demo.kotlin.db.indexes.PAYMENT_IDX_FK_STAFF_ID
import org.jooq.demo.kotlin.db.keys.PAYMENT__PAYMENT_CUSTOMER_ID_FKEY
import org.jooq.demo.kotlin.db.keys.PAYMENT__PAYMENT_PKEY
...
open class Payment(
     ...
     */
    val RENTAL_ID: TableField<PaymentRecord, Long?> = createField(DSL.name("rental_id"), SQLDataType.BIGINT, this, "")
    ...
    override fun getPrimaryKey(): UniqueKey<PaymentRecord> = PAYMENT__PAYMENT_PKEY
