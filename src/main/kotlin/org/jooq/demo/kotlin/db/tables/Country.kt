...
import org.jooq.demo.kotlin.db.keys.COUNTRY__COUNTRY_PKEY
...
open class Country(
     ...
     */
    val LAST_UPDATE: TableField<CountryRecord, LocalDateTime?> = createField(DSL.name("last_update"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("now():::TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "")
    ...
    override fun getPrimaryKey(): UniqueKey<CountryRecord> = COUNTRY__COUNTRY_PKEY
