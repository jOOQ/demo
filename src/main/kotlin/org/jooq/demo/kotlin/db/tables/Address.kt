...
import org.jooq.demo.kotlin.db.indexes.ADDRESS_IDX_FK_CITY_ID
import org.jooq.demo.kotlin.db.keys.ADDRESS__ADDRESS_CITY_ID_FKEY
import org.jooq.demo.kotlin.db.keys.ADDRESS__ADDRESS_PKEY
...
open class Address(
     ...
     */
    val LAST_UPDATE: TableField<AddressRecord, LocalDateTime?> = createField(DSL.name("last_update"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("now():::TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "")
    ...
    override fun getPrimaryKey(): UniqueKey<AddressRecord> = ADDRESS__ADDRESS_PKEY
