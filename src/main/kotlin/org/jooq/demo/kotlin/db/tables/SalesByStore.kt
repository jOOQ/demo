...
open class SalesByStore(
     ...
     */
    val STORE: TableField<SalesByStoreRecord, String?> = createField(DSL.name("store"), SQLDataType.VARCHAR, this, "")

    /**
     * The column <code>public.sales_by_store.manager</code>.
     */
    val MANAGER: TableField<SalesByStoreRecord, String?> = createField(DSL.name("manager"), SQLDataType.VARCHAR, this, "")
