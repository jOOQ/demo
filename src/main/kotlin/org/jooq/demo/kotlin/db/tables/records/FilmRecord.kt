...
open class FilmRecord() : UpdatableRecordImpl<FilmRecord>(Film.FILM), Record13<Long?, String?, String?, Long?, Long?, Long?, Short?, BigDecimal?, Short?, BigDecimal?, MpaaRating?, LocalDateTime?, Array<String?>?> {
    ...
    override fun valuesRow(): Row13<Long?, String?, String?, Long?, Long?, Long?, Short?, BigDecimal?, Short?, BigDecimal?, MpaaRating?, LocalDateTime?, Array<String?>?> = super.valuesRow() as Row13<Long?, String?, String?, Long?, Long?, Long?, Short?, BigDecimal?, Short?, BigDecimal?, MpaaRating?, LocalDateTime?, Array<String?>?>
    ...
    override fun field4(): Field<Long?> = Film.FILM.RELEASE_YEAR
    ...
    override fun component4(): Long? = releaseYear
    ...
    override fun value4(): Long? = releaseYear
    ...
    override fun value4(value: Long?): FilmRecord {
    ...
    override fun values(value1: Long?, value2: String?, value3: String?, value4: Long?, value5: Long?, value6: Long?, value7: Short?, value8: BigDecimal?, value9: Short?, value10: BigDecimal?, value11: MpaaRating?, value12: LocalDateTime?, value13: Array<String?>?): FilmRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(filmId: Long? = null, title: String? = null, description: String? = null, releaseYear: Long? = null, languageId: Long? = null, originalLanguageId: Long? = null, rentalDuration: Short? = null, rentalRate: BigDecimal? = null, length: Short? = null, replacementCost: BigDecimal? = null, rating: MpaaRating? = null, lastUpdate: LocalDateTime? = null, specialFeatures: Array<String?>? = null): this() {
        this.filmId = filmId
        this.title = title
