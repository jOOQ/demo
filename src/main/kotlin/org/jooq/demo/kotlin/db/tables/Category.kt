...
import org.jooq.demo.kotlin.db.keys.CATEGORY__CATEGORY_PKEY
...
open class Category(
     ...
     */
    val LAST_UPDATE: TableField<CategoryRecord, LocalDateTime?> = createField(DSL.name("last_update"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("now():::TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "")
    ...
    override fun getPrimaryKey(): UniqueKey<CategoryRecord> = CATEGORY__CATEGORY_PKEY
