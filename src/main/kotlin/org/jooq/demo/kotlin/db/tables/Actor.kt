...
import org.jooq.demo.kotlin.db.indexes.ACTOR_IDX_ACTOR_LAST_NAME
import org.jooq.demo.kotlin.db.keys.ACTOR__ACTOR_PKEY
...
open class Actor(
     ...
     */
    val LAST_UPDATE: TableField<ActorRecord, LocalDateTime?> = createField(DSL.name("last_update"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("now():::TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "")
    ...
    override fun getPrimaryKey(): UniqueKey<ActorRecord> = ACTOR__ACTOR_PKEY
