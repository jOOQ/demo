...
open class CustomerDao(configuration: Configuration?) : DAOImpl<CustomerRecord, org.jooq.demo.kotlin.db.tables.pojos.Customer, Long>(Customer.CUSTOMER, org.jooq.demo.kotlin.db.tables.pojos.Customer::class.java, configuration) {
     ...
     * upperInclusive</code>
     */
    fun fetchRangeOfActive(lowerInclusive: Long?, upperInclusive: Long?): List<org.jooq.demo.kotlin.db.tables.pojos.Customer> = fetchRange(Customer.CUSTOMER.ACTIVE, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>active IN (values)</code>
     */
    fun fetchByActive(vararg values: Long): List<org.jooq.demo.kotlin.db.tables.pojos.Customer> = fetch(Customer.CUSTOMER.ACTIVE, *values.toTypedArray())
}
