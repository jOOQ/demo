...
open class PaymentP2007_02(
    ...
    val customer: CustomerPath by lazy { CustomerPath(this, PAYMENT_P2007_02__PAYMENT_P2007_02_CUSTOMER_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>public.rental</code> table.
     */
    fun rental(): RentalPath = rental
    val rental: RentalPath by lazy { RentalPath(this, PAYMENT_P2007_02__PAYMENT_P2007_02_RENTAL_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>public.staff</code> table.
     */
    fun staff(): StaffPath = staff
    val staff: StaffPath by lazy { StaffPath(this, PAYMENT_P2007_02__PAYMENT_P2007_02_STAFF_ID_FKEY, null) }
