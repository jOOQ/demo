...
public class CustomerRecord extends UpdatableRecordImpl<CustomerRecord> implements Record10<Long, Long, String, String, String, Long, Boolean, LocalDate, LocalDateTime, Integer> {
    ...
    @Override
    public CustomerRecord values(Long value1, Long value2, String value3, String value4, String value5, Long value6, Boolean value7, LocalDate value8, LocalDateTime value9, Integer value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     * Create a detached, initialised CustomerRecord
     */
    public CustomerRecord(org.jooq.demo.kotlin.db.tables.pojos.Customer value) {
        super(Customer.CUSTOMER);
        ...
        if (value != null) {
            ...
            setActivebool(value.getActivebool());
