 ...
 */
class CategoryRecord extends UpdatableRecordImpl[CategoryRecord](Category.CATEGORY) with Record3[Long, String, LocalDateTime] {
  ...
  override def field1: Field[Long] = Category.CATEGORY.CATEGORY_ID
  override def field2: Field[String] = Category.CATEGORY.NAME
  override def field3: Field[LocalDateTime] = Category.CATEGORY.LAST_UPDATE
  override def component1: Long = getCategoryId
  override def component2: String = getName
  override def component3: LocalDateTime = getLastUpdate
  override def value1: Long = getCategoryId
  override def value2: String = getName
  override def value3: LocalDateTime = getLastUpdate

  override def value1(value: Long): CategoryRecord = {
    setCategoryId(value)
    this
  }

  override def value2(value: String): CategoryRecord = {
    setName(value)
    this
  }

  override def value3(value: LocalDateTime): CategoryRecord = {
    setLastUpdate(value)
    this
  }

  override def values(value1 : Long, value2 : String, value3 : LocalDateTime): CategoryRecord = {
    this.value1(value1)
    this.value2(value2)
    this.value3(value3)
    this
