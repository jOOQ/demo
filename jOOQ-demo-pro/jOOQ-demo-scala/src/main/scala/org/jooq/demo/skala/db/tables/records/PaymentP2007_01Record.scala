 ...
 */
class PaymentP2007_01Record extends TableRecordImpl[PaymentP2007_01Record](PaymentP2007_01.PAYMENT_P2007_01) with Record6[Long, Long, Long, Long, BigDecimal, LocalDateTime] {
  ...
  override def field1: Field[Long] = PaymentP2007_01.PAYMENT_P2007_01.PAYMENT_ID
  override def field2: Field[Long] = PaymentP2007_01.PAYMENT_P2007_01.CUSTOMER_ID
  override def field3: Field[Long] = PaymentP2007_01.PAYMENT_P2007_01.STAFF_ID
  override def field4: Field[Long] = PaymentP2007_01.PAYMENT_P2007_01.RENTAL_ID
  override def field5: Field[BigDecimal] = PaymentP2007_01.PAYMENT_P2007_01.AMOUNT
  override def field6: Field[LocalDateTime] = PaymentP2007_01.PAYMENT_P2007_01.PAYMENT_DATE
  ...
  override def value1(value: Long): PaymentP2007_01Record = {
    setPaymentId(value)
    this
  }

  override def value2(value: Long): PaymentP2007_01Record = {
    setCustomerId(value)
    this
  }

  override def value3(value: Long): PaymentP2007_01Record = {
    setStaffId(value)
    this
  }

  override def value4(value: Long): PaymentP2007_01Record = {
    setRentalId(value)
    this
  }

  override def value5(value: BigDecimal): PaymentP2007_01Record = {
    setAmount(value)
    this
  }

  override def value6(value: LocalDateTime): PaymentP2007_01Record = {
    setPaymentDate(value)
    this
  }

  override def values(value1 : Long, value2 : Long, value3 : Long, value4 : Long, value5 : BigDecimal, value6 : LocalDateTime): PaymentP2007_01Record = {
    this.value1(value1)
    this.value2(value2)
    this.value3(value3)
    this.value4(value4)
   ...
   * Create a detached, initialised PaymentP2007_01Record
   */
  def this(value: org.jooq.demo.skala.db.tables.pojos.PaymentP2007_01) = {
    this()
