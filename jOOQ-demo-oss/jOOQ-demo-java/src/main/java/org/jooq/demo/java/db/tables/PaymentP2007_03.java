...
public class PaymentP2007_03 extends TableImpl<PaymentP2007_03Record> {
    ...
    public <O extends Record> Field<O> customerRow(Function<? super Customer, ? extends TableLike<O>> subquery) {
        return toOneRow(Keys.PAYMENT_P2007_03__PAYMENT_P2007_03_CUSTOMER_ID_FKEY, t -> subquery.apply((Customer) t));
    }
    ...
    public <O extends Record> Field<O> staffRow(Function<? super Staff, ? extends TableLike<O>> subquery) {
        return toOneRow(Keys.PAYMENT_P2007_03__PAYMENT_P2007_03_STAFF_ID_FKEY, t -> subquery.apply((Staff) t));
    }
    ...
    public <O extends Record> Field<O> rentalRow(Function<? super Rental, ? extends TableLike<O>> subquery) {
        return toOneRow(Keys.PAYMENT_P2007_03__PAYMENT_P2007_03_RENTAL_ID_FKEY, t -> subquery.apply((Rental) t));
    }
