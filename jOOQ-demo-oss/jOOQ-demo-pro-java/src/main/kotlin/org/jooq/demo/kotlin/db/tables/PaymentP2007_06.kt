...
open class PaymentP2007_06(
    ...
    override fun getReferences(): List<ForeignKey<PaymentP2007_06Record, *>> = listOf(PAYMENT_P2007_06__PAYMENT_P2007_06_CUSTOMER_ID_FKEY, PAYMENT_P2007_06__PAYMENT_P2007_06_STAFF_ID_FKEY, PAYMENT_P2007_06__PAYMENT_P2007_06_RENTAL_ID_FKEY)
     ...
     * the <code>public.payment_p2007_06</code> to-one parent table.
     */
    fun <O : Record> customerRow(subquery: (Customer) -> TableLike<O>): Field<O> = toOneRow(PAYMENT_P2007_06__PAYMENT_P2007_06_CUSTOMER_ID_FKEY, { subquery(it as Customer) })
     ...
     * the <code>public.payment_p2007_06</code> to-one parent table.
     */
    fun <O : Record> staffRow(subquery: (Staff) -> TableLike<O>): Field<O> = toOneRow(PAYMENT_P2007_06__PAYMENT_P2007_06_STAFF_ID_FKEY, { subquery(it as Staff) })
     ...
     * the <code>public.payment_p2007_06</code> to-one parent table.
     */
    fun <O : Record> rentalRow(subquery: (Rental) -> TableLike<O>): Field<O> = toOneRow(PAYMENT_P2007_06__PAYMENT_P2007_06_RENTAL_ID_FKEY, { subquery(it as Rental) })
    ...
    override fun `as`(alias: Table<*>): PaymentP2007_06 = PaymentP2007_06(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): PaymentP2007_06 = PaymentP2007_06(name.getQualifiedName(), null)
