...
object Keys {
  ...
  val ACTOR_PKEY: UniqueKey[ActorRecord] = Internal.createUniqueKey(Actor.ACTOR, DSL.name("actor_pkey"), Array(Actor.ACTOR.ACTOR_ID).asInstanceOf[Array[TableField[ActorRecord, _] ] ], true)
  val ADDRESS_PKEY: UniqueKey[AddressRecord] = Internal.createUniqueKey(Address.ADDRESS, DSL.name("address_pkey"), Array(Address.ADDRESS.ADDRESS_ID).asInstanceOf[Array[TableField[AddressRecord, _] ] ], true)
  val CATEGORY_PKEY: UniqueKey[CategoryRecord] = Internal.createUniqueKey(Category.CATEGORY, DSL.name("category_pkey"), Array(Category.CATEGORY.CATEGORY_ID).asInstanceOf[Array[TableField[CategoryRecord, _] ] ], true)
  val CITY_PKEY: UniqueKey[CityRecord] = Internal.createUniqueKey(City.CITY, DSL.name("city_pkey"), Array(City.CITY.CITY_ID).asInstanceOf[Array[TableField[CityRecord, _] ] ], true)
  val COUNTRY_PKEY: UniqueKey[CountryRecord] = Internal.createUniqueKey(Country.COUNTRY, DSL.name("country_pkey"), Array(Country.COUNTRY.COUNTRY_ID).asInstanceOf[Array[TableField[CountryRecord, _] ] ], true)
  val CUSTOMER_PKEY: UniqueKey[CustomerRecord] = Internal.createUniqueKey(Customer.CUSTOMER, DSL.name("customer_pkey"), Array(Customer.CUSTOMER.CUSTOMER_ID).asInstanceOf[Array[TableField[CustomerRecord, _] ] ], true)
  val FILM_PKEY: UniqueKey[FilmRecord] = Internal.createUniqueKey(Film.FILM, DSL.name("film_pkey"), Array(Film.FILM.FILM_ID).asInstanceOf[Array[TableField[FilmRecord, _] ] ], true)
  val FILM_ACTOR_PKEY: UniqueKey[FilmActorRecord] = Internal.createUniqueKey(FilmActor.FILM_ACTOR, DSL.name("film_actor_pkey"), Array(FilmActor.FILM_ACTOR.ACTOR_ID, FilmActor.FILM_ACTOR.FILM_ID).asInstanceOf[Array[TableField[FilmActorRecord, _] ] ], true)
  val FILM_CATEGORY_PKEY: UniqueKey[FilmCategoryRecord] = Internal.createUniqueKey(FilmCategory.FILM_CATEGORY, DSL.name("film_category_pkey"), Array(FilmCategory.FILM_CATEGORY.FILM_ID, FilmCategory.FILM_CATEGORY.CATEGORY_ID).asInstanceOf[Array[TableField[FilmCategoryRecord, _] ] ], true)
  val INVENTORY_PKEY: UniqueKey[InventoryRecord] = Internal.createUniqueKey(Inventory.INVENTORY, DSL.name("inventory_pkey"), Array(Inventory.INVENTORY.INVENTORY_ID).asInstanceOf[Array[TableField[InventoryRecord, _] ] ], true)
  val LANGUAGE_PKEY: UniqueKey[LanguageRecord] = Internal.createUniqueKey(Language.LANGUAGE, DSL.name("language_pkey"), Array(Language.LANGUAGE.LANGUAGE_ID).asInstanceOf[Array[TableField[LanguageRecord, _] ] ], true)
  val PAYMENT_PKEY: UniqueKey[PaymentRecord] = Internal.createUniqueKey(Payment.PAYMENT, DSL.name("payment_pkey"), Array(Payment.PAYMENT.PAYMENT_ID).asInstanceOf[Array[TableField[PaymentRecord, _] ] ], true)
  val RENTAL_PKEY: UniqueKey[RentalRecord] = Internal.createUniqueKey(Rental.RENTAL, DSL.name("rental_pkey"), Array(Rental.RENTAL.RENTAL_ID).asInstanceOf[Array[TableField[RentalRecord, _] ] ], true)
  val STAFF_PKEY: UniqueKey[StaffRecord] = Internal.createUniqueKey(Staff.STAFF, DSL.name("staff_pkey"), Array(Staff.STAFF.STAFF_ID).asInstanceOf[Array[TableField[StaffRecord, _] ] ], true)
  val STORE_PKEY: UniqueKey[StoreRecord] = Internal.createUniqueKey(Store.STORE, DSL.name("store_pkey"), Array(Store.STORE.STORE_ID).asInstanceOf[Array[TableField[StoreRecord, _] ] ], true)

  // -------------------------------------------------------------------------
  // FOREIGN KEY definitions
  // -------------------------------------------------------------------------

  val ADDRESS__ADDRESS_CITY_ID_FKEY: ForeignKey[AddressRecord, CityRecord] = Internal.createForeignKey(Address.ADDRESS, DSL.name("address_city_id_fkey"), Array(Address.ADDRESS.CITY_ID).asInstanceOf[Array[TableField[AddressRecord, _] ] ], Keys.CITY_PKEY, Array(City.CITY.CITY_ID).asInstanceOf[Array[TableField[CityRecord, _] ] ], true)
  val CITY__CITY_COUNTRY_ID_FKEY: ForeignKey[CityRecord, CountryRecord] = Internal.createForeignKey(City.CITY, DSL.name("city_country_id_fkey"), Array(City.CITY.COUNTRY_ID).asInstanceOf[Array[TableField[CityRecord, _] ] ], Keys.COUNTRY_PKEY, Array(Country.COUNTRY.COUNTRY_ID).asInstanceOf[Array[TableField[CountryRecord, _] ] ], true)
  val CUSTOMER__CUSTOMER_ADDRESS_ID_FKEY: ForeignKey[CustomerRecord, AddressRecord] = Internal.createForeignKey(Customer.CUSTOMER, DSL.name("customer_address_id_fkey"), Array(Customer.CUSTOMER.ADDRESS_ID).asInstanceOf[Array[TableField[CustomerRecord, _] ] ], Keys.ADDRESS_PKEY, Array(Address.ADDRESS.ADDRESS_ID).asInstanceOf[Array[TableField[AddressRecord, _] ] ], true)
  val CUSTOMER__CUSTOMER_STORE_ID_FKEY: ForeignKey[CustomerRecord, StoreRecord] = Internal.createForeignKey(Customer.CUSTOMER, DSL.name("customer_store_id_fkey"), Array(Customer.CUSTOMER.STORE_ID).asInstanceOf[Array[TableField[CustomerRecord, _] ] ], Keys.STORE_PKEY, Array(Store.STORE.STORE_ID).asInstanceOf[Array[TableField[StoreRecord, _] ] ], true)
  val FILM__FILM_LANGUAGE_ID_FKEY: ForeignKey[FilmRecord, LanguageRecord] = Internal.createForeignKey(Film.FILM, DSL.name("film_language_id_fkey"), Array(Film.FILM.LANGUAGE_ID).asInstanceOf[Array[TableField[FilmRecord, _] ] ], Keys.LANGUAGE_PKEY, Array(Language.LANGUAGE.LANGUAGE_ID).asInstanceOf[Array[TableField[LanguageRecord, _] ] ], true)
  val FILM__FILM_ORIGINAL_LANGUAGE_ID_FKEY: ForeignKey[FilmRecord, LanguageRecord] = Internal.createForeignKey(Film.FILM, DSL.name("film_original_language_id_fkey"), Array(Film.FILM.ORIGINAL_LANGUAGE_ID).asInstanceOf[Array[TableField[FilmRecord, _] ] ], Keys.LANGUAGE_PKEY, Array(Language.LANGUAGE.LANGUAGE_ID).asInstanceOf[Array[TableField[LanguageRecord, _] ] ], true)
  val FILM_ACTOR__FILM_ACTOR_ACTOR_ID_FKEY: ForeignKey[FilmActorRecord, ActorRecord] = Internal.createForeignKey(FilmActor.FILM_ACTOR, DSL.name("film_actor_actor_id_fkey"), Array(FilmActor.FILM_ACTOR.ACTOR_ID).asInstanceOf[Array[TableField[FilmActorRecord, _] ] ], Keys.ACTOR_PKEY, Array(Actor.ACTOR.ACTOR_ID).asInstanceOf[Array[TableField[ActorRecord, _] ] ], true)
  val FILM_ACTOR__FILM_ACTOR_FILM_ID_FKEY: ForeignKey[FilmActorRecord, FilmRecord] = Internal.createForeignKey(FilmActor.FILM_ACTOR, DSL.name("film_actor_film_id_fkey"), Array(FilmActor.FILM_ACTOR.FILM_ID).asInstanceOf[Array[TableField[FilmActorRecord, _] ] ], Keys.FILM_PKEY, Array(Film.FILM.FILM_ID).asInstanceOf[Array[TableField[FilmRecord, _] ] ], true)
  val FILM_CATEGORY__FILM_CATEGORY_CATEGORY_ID_FKEY: ForeignKey[FilmCategoryRecord, CategoryRecord] = Internal.createForeignKey(FilmCategory.FILM_CATEGORY, DSL.name("film_category_category_id_fkey"), Array(FilmCategory.FILM_CATEGORY.CATEGORY_ID).asInstanceOf[Array[TableField[FilmCategoryRecord, _] ] ], Keys.CATEGORY_PKEY, Array(Category.CATEGORY.CATEGORY_ID).asInstanceOf[Array[TableField[CategoryRecord, _] ] ], true)
  ...
  val INVENTORY__INVENTORY_FILM_ID_FKEY: ForeignKey[InventoryRecord, FilmRecord] = Internal.createForeignKey(Inventory.INVENTORY, DSL.name("inventory_film_id_fkey"), Array(Inventory.INVENTORY.FILM_ID).asInstanceOf[Array[TableField[InventoryRecord, _] ] ], Keys.FILM_PKEY, Array(Film.FILM.FILM_ID).asInstanceOf[Array[TableField[FilmRecord, _] ] ], true)
  val INVENTORY__INVENTORY_STORE_ID_FKEY: ForeignKey[InventoryRecord, StoreRecord] = Internal.createForeignKey(Inventory.INVENTORY, DSL.name("inventory_store_id_fkey"), Array(Inventory.INVENTORY.STORE_ID).asInstanceOf[Array[TableField[InventoryRecord, _] ] ], Keys.STORE_PKEY, Array(Store.STORE.STORE_ID).asInstanceOf[Array[TableField[StoreRecord, _] ] ], true)
  val PAYMENT__PAYMENT_CUSTOMER_ID_FKEY: ForeignKey[PaymentRecord, CustomerRecord] = Internal.createForeignKey(Payment.PAYMENT, DSL.name("payment_customer_id_fkey"), Array(Payment.PAYMENT.CUSTOMER_ID).asInstanceOf[Array[TableField[PaymentRecord, _] ] ], Keys.CUSTOMER_PKEY, Array(Customer.CUSTOMER.CUSTOMER_ID).asInstanceOf[Array[TableField[CustomerRecord, _] ] ], true)
  val PAYMENT__PAYMENT_RENTAL_ID_FKEY: ForeignKey[PaymentRecord, RentalRecord] = Internal.createForeignKey(Payment.PAYMENT, DSL.name("payment_rental_id_fkey"), Array(Payment.PAYMENT.RENTAL_ID).asInstanceOf[Array[TableField[PaymentRecord, _] ] ], Keys.RENTAL_PKEY, Array(Rental.RENTAL.RENTAL_ID).asInstanceOf[Array[TableField[RentalRecord, _] ] ], true)
  val PAYMENT__PAYMENT_STAFF_ID_FKEY: ForeignKey[PaymentRecord, StaffRecord] = Internal.createForeignKey(Payment.PAYMENT, DSL.name("payment_staff_id_fkey"), Array(Payment.PAYMENT.STAFF_ID).asInstanceOf[Array[TableField[PaymentRecord, _] ] ], Keys.STAFF_PKEY, Array(Staff.STAFF.STAFF_ID).asInstanceOf[Array[TableField[StaffRecord, _] ] ], true)
  ...
  val STAFF__STAFF_ADDRESS_ID_FKEY: ForeignKey[StaffRecord, AddressRecord] = Internal.createForeignKey(Staff.STAFF, DSL.name("staff_address_id_fkey"), Array(Staff.STAFF.ADDRESS_ID).asInstanceOf[Array[TableField[StaffRecord, _] ] ], Keys.ADDRESS_PKEY, Array(Address.ADDRESS.ADDRESS_ID).asInstanceOf[Array[TableField[AddressRecord, _] ] ], true)
  val STAFF__STAFF_STORE_ID_FKEY: ForeignKey[StaffRecord, StoreRecord] = Internal.createForeignKey(Staff.STAFF, DSL.name("staff_store_id_fkey"), Array(Staff.STAFF.STORE_ID).asInstanceOf[Array[TableField[StaffRecord, _] ] ], Keys.STORE_PKEY, Array(Store.STORE.STORE_ID).asInstanceOf[Array[TableField[StoreRecord, _] ] ], true)
  val STORE__STORE_ADDRESS_ID_FKEY: ForeignKey[StoreRecord, AddressRecord] = Internal.createForeignKey(Store.STORE, DSL.name("store_address_id_fkey"), Array(Store.STORE.ADDRESS_ID).asInstanceOf[Array[TableField[StoreRecord, _] ] ], Keys.ADDRESS_PKEY, Array(Address.ADDRESS.ADDRESS_ID).asInstanceOf[Array[TableField[AddressRecord, _] ] ], true)
  val STORE__STORE_MANAGER_STAFF_ID_FKEY: ForeignKey[StoreRecord, StaffRecord] = Internal.createForeignKey(Store.STORE, DSL.name("store_manager_staff_id_fkey"), Array(Store.STORE.MANAGER_STAFF_ID).asInstanceOf[Array[TableField[StoreRecord, _] ] ], Keys.STAFF_PKEY, Array(Staff.STAFF.STAFF_ID).asInstanceOf[Array[TableField[StaffRecord, _] ] ], true)
}
