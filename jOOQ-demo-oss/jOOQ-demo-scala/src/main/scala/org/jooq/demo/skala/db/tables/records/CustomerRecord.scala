 ...
 */
class CustomerRecord extends UpdatableRecordImpl[CustomerRecord](Customer.CUSTOMER) with Record10[Long, Long, String, String, String, Long, Boolean, LocalDate, LocalDateTime, Integer] {
  ...
  override def values(value1 : Long, value2 : Long, value3 : String, value4 : String, value5 : String, value6 : Long, value7 : Boolean, value8 : LocalDate, value9 : LocalDateTime, value10 : Integer): CustomerRecord = {
    this.value1(value1)
    this.value2(value2)
    this.value3(value3)
    this.value4(value4)
