...
public class PaymentDao extends DAOImpl<PaymentRecord, org.jooq.demo.skala.db.tables.pojos.Payment, Long> {

    /**
     * Create a new PaymentDao without any configuration
     */
    public PaymentDao() {
        super(Payment.PAYMENT, org.jooq.demo.skala.db.tables.pojos.Payment.class);
    }
    ...
    public PaymentDao(Configuration configuration) {
        super(Payment.PAYMENT, org.jooq.demo.skala.db.tables.pojos.Payment.class, configuration);
    }

    @Override
    public Long getId(org.jooq.demo.skala.db.tables.pojos.Payment object) {
     ...
     * upperInclusive</code>
     */
    public List<org.jooq.demo.skala.db.tables.pojos.Payment> fetchRangeOfPaymentId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<org.jooq.demo.skala.db.tables.pojos.Payment> fetchByPaymentId(Long... values) {
     ...
     */
    public org.jooq.demo.skala.db.tables.pojos.Payment fetchOneByPaymentId(Long value) {
     ...
     * Fetch a unique record that has <code>payment_id = value</code>
     */
    public Optional<org.jooq.demo.skala.db.tables.pojos.Payment> fetchOptionalByPaymentId(Long value) {
     ...
     * upperInclusive</code>
     */
    public List<org.jooq.demo.skala.db.tables.pojos.Payment> fetchRangeOfCustomerId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<org.jooq.demo.skala.db.tables.pojos.Payment> fetchByCustomerId(Long... values) {
     ...
     * upperInclusive</code>
     */
    public List<org.jooq.demo.skala.db.tables.pojos.Payment> fetchRangeOfStaffId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<org.jooq.demo.skala.db.tables.pojos.Payment> fetchByStaffId(Long... values) {
     ...
     * upperInclusive</code>
     */
    public List<org.jooq.demo.skala.db.tables.pojos.Payment> fetchRangeOfRentalId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<org.jooq.demo.skala.db.tables.pojos.Payment> fetchByRentalId(Long... values) {
     ...
     * upperInclusive</code>
     */
    public List<org.jooq.demo.skala.db.tables.pojos.Payment> fetchRangeOfAmount(BigDecimal lowerInclusive, BigDecimal upperInclusive) {
     ...
     */
    public List<org.jooq.demo.skala.db.tables.pojos.Payment> fetchByAmount(BigDecimal... values) {
     ...
     * upperInclusive</code>
     */
    public List<org.jooq.demo.skala.db.tables.pojos.Payment> fetchRangeOfPaymentDate(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<org.jooq.demo.skala.db.tables.pojos.Payment> fetchByPaymentDate(LocalDateTime... values) {
