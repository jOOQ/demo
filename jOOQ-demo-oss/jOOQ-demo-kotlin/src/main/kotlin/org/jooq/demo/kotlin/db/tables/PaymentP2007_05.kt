...
open class PaymentP2007_05(
    ...
    fun customer(): CustomerPath {
        if (!this::_customer.isInitialized)
            _customer = CustomerPath(this, PAYMENT_P2007_05__PAYMENT_P2007_05_CUSTOMER_ID_FKEY, null)
    ...
    fun rental(): RentalPath {
        if (!this::_rental.isInitialized)
            _rental = RentalPath(this, PAYMENT_P2007_05__PAYMENT_P2007_05_RENTAL_ID_FKEY, null)
