...
open class PaymentP2007_06(
    ...
    path: ForeignKey<out Record, PaymentP2007_06Record>?,
     ...
     */
    public override fun getRecordType(): Class<PaymentP2007_06Record> = PaymentP2007_06Record::class.java
    ...
    private constructor(alias: Name, aliased: Table<PaymentP2007_06Record>?): this(alias, null, null, aliased, null)
    private constructor(alias: Name, aliased: Table<PaymentP2007_06Record>?, parameters: Array<Field<*>?>?): this(alias, null, null, aliased, parameters)
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, PaymentP2007_06Record>): this(Internal.createPathAlias(child, key), child, key, PAYMENT_P2007_06, null)
    public override fun getSchema(): Schema? = if (aliased()) null else Public.PUBLIC
    public override fun getIndexes(): List<Index> = listOf(IDX_FK_PAYMENT_P2007_06_CUSTOMER_ID, IDX_FK_PAYMENT_P2007_06_STAFF_ID)
    public override fun getIdentity(): Identity<PaymentP2007_06Record, Long?> = super.getIdentity() as Identity<PaymentP2007_06Record, Long?>
    public override fun getReferences(): List<ForeignKey<PaymentP2007_06Record, *>> = listOf(PAYMENT_P2007_06__PAYMENT_P2007_06_CUSTOMER_ID_FKEY, PAYMENT_P2007_06__PAYMENT_P2007_06_STAFF_ID_FKEY, PAYMENT_P2007_06__PAYMENT_P2007_06_RENTAL_ID_FKEY)
    ...
    fun staff(): Staff {
        if (!this::_staff.isInitialized)
            _staff = Staff(this, PAYMENT_P2007_06__PAYMENT_P2007_06_STAFF_ID_FKEY)
    ...
    fun rental(): Rental {
        if (!this::_rental.isInitialized)
            _rental = Rental(this, PAYMENT_P2007_06__PAYMENT_P2007_06_RENTAL_ID_FKEY)
    ...
    val rental: Rental
        get(): Rental = rental()
    public override fun getChecks(): List<Check<PaymentP2007_06Record>> = listOf(
    ...
    public override fun `as`(alias: String): PaymentP2007_06 = PaymentP2007_06(DSL.name(alias), this)
    public override fun `as`(alias: Name): PaymentP2007_06 = PaymentP2007_06(alias, this)
    public override fun `as`(alias: Table<*>): PaymentP2007_06 = PaymentP2007_06(alias.getQualifiedName(), this)

    /**
     * Rename this table
     */
    public override fun rename(name: String): PaymentP2007_06 = PaymentP2007_06(DSL.name(name), null)

    /**
     * Rename this table
     */
    public override fun rename(name: Name): PaymentP2007_06 = PaymentP2007_06(name, null)

    /**
     * Rename this table
     */
    public override fun rename(name: Table<*>): PaymentP2007_06 = PaymentP2007_06(name.getQualifiedName(), null)
