...
open class PaymentP2007_03Record() : TableRecordImpl<PaymentP2007_03Record>(PaymentP2007_03.PAYMENT_P2007_03), Record6<Long?, Long?, Long?, Long?, BigDecimal?, LocalDateTime?> {
    ...
    public override fun field1(): Field<Long?> = PaymentP2007_03.PAYMENT_P2007_03.PAYMENT_ID
    public override fun field2(): Field<Long?> = PaymentP2007_03.PAYMENT_P2007_03.CUSTOMER_ID
    public override fun field3(): Field<Long?> = PaymentP2007_03.PAYMENT_P2007_03.STAFF_ID
    public override fun field4(): Field<Long?> = PaymentP2007_03.PAYMENT_P2007_03.RENTAL_ID
    public override fun field5(): Field<BigDecimal?> = PaymentP2007_03.PAYMENT_P2007_03.AMOUNT
    public override fun field6(): Field<LocalDateTime?> = PaymentP2007_03.PAYMENT_P2007_03.PAYMENT_DATE
    ...
    public override fun value1(value: Long?): PaymentP2007_03Record {
        set(0, value)
        return this
    }

    public override fun value2(value: Long?): PaymentP2007_03Record {
        set(1, value)
        return this
    }

    public override fun value3(value: Long?): PaymentP2007_03Record {
        set(2, value)
        return this
    }

    public override fun value4(value: Long?): PaymentP2007_03Record {
        set(3, value)
        return this
    }

    public override fun value5(value: BigDecimal?): PaymentP2007_03Record {
        set(4, value)
        return this
    }

    public override fun value6(value: LocalDateTime?): PaymentP2007_03Record {
        set(5, value)
        return this
    }

    public override fun values(value1: Long?, value2: Long?, value3: Long?, value4: Long?, value5: BigDecimal?, value6: LocalDateTime?): PaymentP2007_03Record {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
