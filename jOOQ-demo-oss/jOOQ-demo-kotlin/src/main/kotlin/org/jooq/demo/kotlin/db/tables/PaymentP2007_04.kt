...
open class PaymentP2007_04(
    ...
    override fun getReferences(): List<ForeignKey<PaymentP2007_04Record, *>> = listOf(PAYMENT_P2007_04__PAYMENT_P2007_04_CUSTOMER_ID_FKEY, PAYMENT_P2007_04__PAYMENT_P2007_04_RENTAL_ID_FKEY, PAYMENT_P2007_04__PAYMENT_P2007_04_STAFF_ID_FKEY)

    /**
     * Get the implicit join path to the <code>public.customer</code> table.
     */
    fun customer(): CustomerPath = customer
    val customer: CustomerPath by lazy { CustomerPath(this, PAYMENT_P2007_04__PAYMENT_P2007_04_CUSTOMER_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>public.rental</code> table.
     */
    fun rental(): RentalPath = rental
    val rental: RentalPath by lazy { RentalPath(this, PAYMENT_P2007_04__PAYMENT_P2007_04_RENTAL_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>public.staff</code> table.
     */
    fun staff(): StaffPath = staff
    val staff: StaffPath by lazy { StaffPath(this, PAYMENT_P2007_04__PAYMENT_P2007_04_STAFF_ID_FKEY, null) }
