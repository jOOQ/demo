...
open class CustomerRecord() : UpdatableRecordImpl<CustomerRecord>(Customer.CUSTOMER), Record12<Long?, Long?, String?, String?, String?, Long?, Boolean?, LocalDate?, LocalDateTime?, Int?, String?, String?> {
    ...
    override fun valuesRow(): Row12<Long?, Long?, String?, String?, String?, Long?, Boolean?, LocalDate?, LocalDateTime?, Int?, String?, String?> = super.valuesRow() as Row12<Long?, Long?, String?, String?, String?, Long?, Boolean?, LocalDate?, LocalDateTime?, Int?, String?, String?>
    ...
    override fun field11(): Field<String?> = Customer.CUSTOMER.FULL_ADDRESS
    override fun field12(): Field<String?> = Customer.CUSTOMER.FULL_NAME
    ...
    override fun component11(): String? = fullAddress
    override fun component12(): String? = fullName
    ...
    override fun value11(): String? = fullAddress
    override fun value12(): String? = fullName
    ...
    override fun value11(value: String?): CustomerRecord {
        this.fullAddress = value
        return this
    }

    override fun value12(value: String?): CustomerRecord {
        this.fullName = value
        return this
    }

    override fun values(value1: Long?, value2: Long?, value3: String?, value4: String?, value5: String?, value6: Long?, value7: Boolean?, value8: LocalDate?, value9: LocalDateTime?, value10: Int?, value11: String?, value12: String?): CustomerRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(customerId: Long? = null, storeId: Long? = null, firstName: String? = null, lastName: String? = null, email: String? = null, addressId: Long? = null, activebool: Boolean? = null, createDate: LocalDate? = null, lastUpdate: LocalDateTime? = null, active: Int? = null, fullAddress: String? = null, fullName: String? = null): this() {
     ...
     * Create a detached, initialised CustomerRecord
     */
    constructor(customerId: Long? = null, storeId: Long? = null, firstName: String? = null, lastName: String? = null, email: String? = null, addressId: Long? = null, activebool: Boolean? = null, createDate: LocalDate? = null, active: Int? = null, fullAddress: String? = null, fullName: String? = null): this() {
        this.customerId = customerId
        this.storeId = storeId
        this.firstName = firstName
        this.lastName = lastName
