...
open class NicerButSlowerFilmListRecord() : TableRecordImpl<NicerButSlowerFilmListRecord>(NicerButSlowerFilmList.NICER_BUT_SLOWER_FILM_LIST), Record8<Long?, String?, String?, String?, BigDecimal?, Short?, MpaaRating?, String?> {
    ...
    public override fun field1(): Field<Long?> = NicerButSlowerFilmList.NICER_BUT_SLOWER_FILM_LIST.FID
    public override fun field2(): Field<String?> = NicerButSlowerFilmList.NICER_BUT_SLOWER_FILM_LIST.TITLE
    public override fun field3(): Field<String?> = NicerButSlowerFilmList.NICER_BUT_SLOWER_FILM_LIST.DESCRIPTION
    public override fun field4(): Field<String?> = NicerButSlowerFilmList.NICER_BUT_SLOWER_FILM_LIST.CATEGORY
    public override fun field5(): Field<BigDecimal?> = NicerButSlowerFilmList.NICER_BUT_SLOWER_FILM_LIST.PRICE
    public override fun field6(): Field<Short?> = NicerButSlowerFilmList.NICER_BUT_SLOWER_FILM_LIST.LENGTH
    public override fun field7(): Field<MpaaRating?> = NicerButSlowerFilmList.NICER_BUT_SLOWER_FILM_LIST.RATING
    public override fun field8(): Field<String?> = NicerButSlowerFilmList.NICER_BUT_SLOWER_FILM_LIST.ACTORS
    ...
    public override fun value1(value: Long?): NicerButSlowerFilmListRecord {
        set(0, value)
        return this
    }

    public override fun value2(value: String?): NicerButSlowerFilmListRecord {
        set(1, value)
        return this
    }

    public override fun value3(value: String?): NicerButSlowerFilmListRecord {
        set(2, value)
        return this
    }

    public override fun value4(value: String?): NicerButSlowerFilmListRecord {
        set(3, value)
        return this
    }

    public override fun value5(value: BigDecimal?): NicerButSlowerFilmListRecord {
        set(4, value)
        return this
    }

    public override fun value6(value: Short?): NicerButSlowerFilmListRecord {
        set(5, value)
        return this
    }

    public override fun value7(value: MpaaRating?): NicerButSlowerFilmListRecord {
        set(6, value)
        return this
    }

    public override fun value8(value: String?): NicerButSlowerFilmListRecord {
        set(7, value)
        return this
    }

    public override fun values(value1: Long?, value2: String?, value3: String?, value4: String?, value5: BigDecimal?, value6: Short?, value7: MpaaRating?, value8: String?): NicerButSlowerFilmListRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
