...
open class PaymentP2007_01(
    ...
    fun customer(): CustomerPath {
        if (!this::_customer.isInitialized)
            _customer = CustomerPath(this, PAYMENT_P2007_01__PAYMENT_P2007_01_CUSTOMER_ID_FKEY, null)
    ...
    fun rental(): RentalPath {
        if (!this::_rental.isInitialized)
            _rental = RentalPath(this, PAYMENT_P2007_01__PAYMENT_P2007_01_RENTAL_ID_FKEY, null)
    ...
    fun staff(): StaffPath {
        if (!this::_staff.isInitialized)
            _staff = StaffPath(this, PAYMENT_P2007_01__PAYMENT_P2007_01_STAFF_ID_FKEY, null)
