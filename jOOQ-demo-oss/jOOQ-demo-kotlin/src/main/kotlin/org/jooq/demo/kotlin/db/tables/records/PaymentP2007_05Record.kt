...
open class PaymentP2007_05Record() : TableRecordImpl<PaymentP2007_05Record>(PaymentP2007_05.PAYMENT_P2007_05), Record6<Long?, Long?, Long?, Long?, BigDecimal?, LocalDateTime?> {
    ...
    public override fun field1(): Field<Long?> = PaymentP2007_05.PAYMENT_P2007_05.PAYMENT_ID
    public override fun field2(): Field<Long?> = PaymentP2007_05.PAYMENT_P2007_05.CUSTOMER_ID
    public override fun field3(): Field<Long?> = PaymentP2007_05.PAYMENT_P2007_05.STAFF_ID
    public override fun field4(): Field<Long?> = PaymentP2007_05.PAYMENT_P2007_05.RENTAL_ID
    public override fun field5(): Field<BigDecimal?> = PaymentP2007_05.PAYMENT_P2007_05.AMOUNT
    public override fun field6(): Field<LocalDateTime?> = PaymentP2007_05.PAYMENT_P2007_05.PAYMENT_DATE
    ...
    public override fun value1(value: Long?): PaymentP2007_05Record {
        set(0, value)
        return this
    }

    public override fun value2(value: Long?): PaymentP2007_05Record {
        set(1, value)
        return this
    }

    public override fun value3(value: Long?): PaymentP2007_05Record {
        set(2, value)
        return this
    }

    public override fun value4(value: Long?): PaymentP2007_05Record {
        set(3, value)
        return this
    }

    public override fun value5(value: BigDecimal?): PaymentP2007_05Record {
        set(4, value)
        return this
    }

    public override fun value6(value: LocalDateTime?): PaymentP2007_05Record {
        set(5, value)
        return this
    }

    public override fun values(value1: Long?, value2: Long?, value3: Long?, value4: Long?, value5: BigDecimal?, value6: LocalDateTime?): PaymentP2007_05Record {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     * Create a detached, initialised PaymentP2007_05Record
     */
    constructor(value: org.jooq.demo.kotlin.db.tables.pojos.PaymentP2007_05?): this() {
        if (value != null) {
